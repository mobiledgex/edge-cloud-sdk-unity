...
namespace MobiledgeX
{
  ...
  public class LocationService : MonoBehaviour
  {
    ...
    /// <summary>
    /// Converts Time in seconds to TimeStamp
    /// </summary>
    /// <param name="timeInSeconds">(double)time in seconds</param>
    ...
    /// <summary>
    /// Converts LocationInfo object to DistributedMatchEngine.Loc object
    /// </summary>
    /// <param name="info">LocationInfo Object</param>
    /// <returns> DistributedMatchEngine.Loc object</returns>
